    ...
    <div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
      <div class="ui-block">
        <div class="ui-block-title">
          ...
          <a class="btn btn-control bg-blue" id="new_message_button">
            <svg class="olymp-plus-icon"><use xlink:href="{{ asset('svg-icons/sprites/icons.svg#olymp-plus-icon') }}"></use></svg>
          </a>
          <a class="btn btn-control bg-orange" id="more_button">
        ...
        <div class="row">
          <div class="col col-xl-5 col-lg-6 col-md-12 col-sm-12  padding-r-0">
            ...
            <ul class="notification-list chat-message" id="messages_container">

              @if(isset($conversations) && count($conversations) > 0 && $conversations[0] !== '')
                @foreach($conversations as $conversation)
                  @php
                    $receiver = User::where('uuid', explode(',', $conversation)[0])->first();
                    $file = explode(',', $conversation)[1];
                  @endphp
                  <li>
                    ...
                    <div class="notification-event">
                      <a href="#" class="h6 notification-friend">{{ $receiver->firstname . ' ' . $receiver->lastname }}</a>
          ...
          <div class="col col-xl-7 col-lg-6 col-md-12 col-sm-12  padding-l-0" id="chat_field_container">
...
<script>
  ...
  var new_message_address_field = `<li id="new_message_address_field">
                                     <div class="author-thumb">
                                       <img src="https://i.imgur.com/3gokj8j.png" alt="author" style="width: 100%; height: 100%;" id="profile_image">
                                     </div>
                                     <div class="notification-event">
                                       <!-- <input class="h6 notification-friend" placeholder="To:"></input> -->
                                       <div class="form-group label-floating is-empty">
                                         <label class="control-label">New Message</label>
                                         <input class="form-control" placeholder="" style="overflow-x: scroll;"></input>
                                       </div>
                                       <!-- <span class="chat-message-item">Hi James! It’s Diana, I just wanted to let you know that we have to reschedule...</span> -->
                                       <!-- <span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">4 hours ago</time></span> -->
                                     </div>
  ...
  var new_message_chat_field = `<div class="chat-field" id="new_message_chat_field">
                                  <div class="ui-block-title">
                                    <h6 class="title" id="name_field"></h6>
                                    <a href="#" class="more"><svg class="olymp-three-dots-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg></a>
                                  </div>
                                  <div class="mCustomScrollbar" data-mcs-theme="dark">
                                    <ul class="notification-list chat-message chat-message-field">
  ...
  $(document).ready(function() {
    ...
    $('#new_message_button').click(function(e) {
      if ($(this).hasClass('bg-blue')) {
        $('#messages_container').html(new_message_address_field + $('#messages_container').html());
        $('#chat_field_container').html(new_message_chat_field + $('#chat_field_container').html());
        ...
        $('#new_message_address_field').remove();
        $('#new_message_chat_field').remove();
        $(this).addClass('bg-blue');
        $(this).removeClass('bg-red');
        $(this).html('<svg class="olymp-plus-icon"><use xlink:href="{{ asset('svg-icons/sprites/icons.svg#olymp-plus-icon') }}"></use></svg>');
      }
    });
