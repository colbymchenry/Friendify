	...
	<div class="row display-flex">
		<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
			<div class="landing-content">
				...
				<p>We believe making friends should be easy and accurate. Friends should be people you hang out with in real life that you truly get along with. Join now to see who you match with!
				</p>
			...
			<div class="registration-login-form">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home" role="tabpanel" data-mh="log-tab">
						<div class="title h6">Register to Friendify</div>
						<form class="content">
							<div class="row">
						...
						<form class="content">
							<div class="row">
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<a href="#" class="btn btn-lg bg-google full-width btn-icon-left"><i class="fab fa-google" aria-hidden="true"></i>Login with Google</a>
